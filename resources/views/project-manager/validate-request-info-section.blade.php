...
<div class="list-group">
        ...
        @endif
        <div>
            <form style="display: inline-block" action="{{route('vacationRequestApprovers.approveVacationRequest', $vacationRequest->id)}}" method="POST">
                @csrf
                <button type="submit" class="btn btn-success">Approve</button>
            </form>
            <form style="display: inline-block" action="{{route('vacationRequestApprovers.rejectVacationRequest', $vacationRequest->id)}}" method="POST">
                @csrf 
